To explore density-based clustering techniques, implement DBSCAN and an alternative HDBSCAN algorithms, compare their performance on different datasets. (digits, seeds and tumor dataset)
